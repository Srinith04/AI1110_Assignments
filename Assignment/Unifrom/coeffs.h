...
//Defining the function for calculating the mean_sqr of random numbers
...
//End function for calculating the mean_sqr of random numbers
...
temp = mean_sqr(str) - mean(str)*mean(str);
