...
\begin{abstract}
This document contains the solution for Assignment 9 (NCERT GRADE 12 CHAPTER 13 Exercise 13.3 Question 5)
\end{abstract}
%template ends here
\textbf{QUESTION 5 :}
...
\begin{align}
    ...
    \label{eq:3}
\end{align}
and since the events $X=0$ and $X=1$ are complimentary to each other ,
\begin{align}
    \pr{(X=0)} + \pr{(X=1)} &= 1 \\
    \pr{(X=0)} &= 1 - 0.001 \\
    \pr{(X=0)} &= 0.999
...
\begin{align}
    ...
    \label{eq:8}
\end{align}
then , from \eqref{eq:1},\eqref{eq:2},\eqref{eq:3}
\begin{align}
    p &= (0.001)(0.99) = 0.00099 \\
    q &= (0.999)(0.005) = 0.004995 
\end{align}

By using \eqref{eq:7},\eqref{eq:8} in the Bayes' theorem we have
\begin{align}
    \pr{(X=1)|(Y=1)} &= \dfrac{p}{p+q} \\[10pt]
     &= \dfrac{0.00099}{0.00099 + 0.004995} \\[10pt]
