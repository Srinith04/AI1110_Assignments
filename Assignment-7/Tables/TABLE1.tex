...
\hhline{|---|~}
	...
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}\gnumbox{Zero heads in the trial}}
	&\multicolumn{1}{p{\gnumericColC}|}%
...
\hhline{|---|~}
	...
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}\gnumbox{Exactly one head in the trial}}
	&\multicolumn{1}{p{\gnumericColC}|}%
...
\hhline{|---|~}
	...
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}\gnumbox{Exactly two heads in the trial}}
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\centering}\gnumbox{$\dfrac{3}{8}$}}
\\
\hhline{|---|~}
	...
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}\gnumbox{All three heads in the trial}}
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\centering}\gnumbox{$\dfrac{1}{8}$}}
\\
\hhline{|-|-|-|~}
